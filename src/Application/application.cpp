...
void Application::RecreateFontAtlas()
{
    ...
    m_DefaultFont = io.Fonts->AddFontFromFileTTF("resources/fonts/OpenSans-Regular.ttf", 18.0f, &config);
    m_HeaderFont  = io.Fonts->AddFontFromFileTTF("resources/fonts/OpenSans-Bold.ttf",  20.0f, &config);
